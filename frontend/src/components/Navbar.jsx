...
const Navbar = () => {
  const { setShowLogin, user, logout, isOwner, setIsOwner, axios, setToken } =
    useAppContext();
  ...
  return (
    <div
      className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 text gray-600 border-borderColor relative transition-all ${
    ...
    >
      ...
      >
        ...
        <div className="hidden lg:flex items-center text-sm gap-2 border border-borderColor px-3  rounded-full bg-transparent max-w-56">
          <input
            type="text"
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          ...
          <button
            ...
            className="cursor-pointer px-8 py-2 bg-primary rounded-lg"
          >
            {user ? "Logout" : "Login"}
          </button>
        </div>
